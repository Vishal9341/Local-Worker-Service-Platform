...
const ForgotPassword = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const res = await fetch('https://local-worker-service-platform.onrender.com/api/auth/forgot-password', {
        method: 'POST',
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await fetch('https://local-worker-service-platform.onrender.com/api/auth/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
